...
export function AdsterraArticleTop() {
  ...
  return (
    <div className="ad-placement ad-placement-top" style={{ minHeight: 90 }}>
      <AdsterraLeaderboard />
    </div>
  );
}
...
export function AdsterraArticleMid() {
  ...
  return (
    <div className="ad-placement ad-placement-mid" style={{ minHeight: 120 }}>
      <AdsterraNative1 />
    </div>
  );
}
...
export function AdsterraArticleBottom() {
  ...
  return (
    <div className="ad-placement ad-placement-bottom" style={{ minHeight: 250 }}>
      <AdsterraRectangle />
    </div>
  );
}
...
export function AdsterraToolAd() {
  ...
  return (
    <div className="ad-placement ad-placement-tool" style={{ minHeight: 90 }}>
      <AdsterraLeaderboard />
    </div>
  );
}
